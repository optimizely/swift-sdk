...
class NotificationCenterTests: XCTestCase {
    ...
    func sendDecision() {
        notificationCenter.sendNotifications(type: NotificationType.Decision.rawValue, args: [Constants.NotificationKeys.OptimizelyDecisionTypeFeatureVariable, "userId", nil, ["url":"https://url.com/", "body": Data()]])
