Pod::Spec.new do |s|
  ...
  # OptimizelyDebugger log database (do not use "resource_bundles" which fails db auto generation)
  s.resources               = ["Sources/OptimizelyDebugger/OptimizelyLogModel.xcdatamodeld"]
